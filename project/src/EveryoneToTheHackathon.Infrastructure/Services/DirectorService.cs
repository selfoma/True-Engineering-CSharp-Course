...
public interface IDirectorService
{
    ...
    void FinishHackathon(List<HackathonDreamTeam> dreamTeam);
...
public class DirectorService(IHackathonService hackathonService) : IDirectorService
{
    ...
    public void FinishHackathon(List<HackathonDreamTeam> dreamTeam)
    {
        Logger.Info("Finishing hackathon");
        hackathonService.ComputeHarmonicAndFinish(dreamTeam);
    }
